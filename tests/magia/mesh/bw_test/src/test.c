...
// #define REPEATS    5                  // multiple repeats for averaging
// #define DMA_CHUNK_SIZE 0x4000         // 16 KB per DMA chunk (unused but kept)

// #define L2_SRC_BASE  0xC0000000       // L2 base address for this test
...
#define N_BUFFS    16                   // Number of Kilobytes to be transferred
...
int main(void) {
    ...
    for(uint32_t i = 0; i < REPEATS; i++){
        // if(hartid == i){
            ...
            printf("[TILE %d]: IDMA L2 -> L1: %d cycles\n", hartid, (stop_l2l1 - start_l2l1)); //TODO: use array to save results and improve the print (START_DF END_DF)
